...
GCC_OPTS = -Wall -Os -std=gnu99 -fdata-sections -ffunction-sections -mmcu=atmega328p -c
LD_OPTS = -Wl,-u,vfprintf,--gc-sections -lprintf_flt -lm -mmcu=atmega328p
ILIBS = -Ilibraries
...
build/testAVR.out: objdir/testAVR.o
	avr-gcc ./objdir/testAVR.o -o ./build/testAVR.out $(LD_OPTS)
	cp ./build/testAVR.out ./build/linkobj.out

objdir/testAVR.o: test/testAVR.c
	avr-gcc ./test/testAVR.c -o ./objdir/testAVR.o $(ILIBS) $(GCC_OPTS)

objdir/testAVRUART.o: test/testAVRUART.c
	avr-gcc ./test/testAVRUART.c -o objdir/testAVRUART.o $(ILIBS) $(GCC_OPTS)

build/testAVRUART.out: objdir/testAVRUART.o objdir/uart.o
	avr-gcc objdir/testAVRUART.o objdir/uart.o -o build/testAVRUART.out $(LD_OPTS)
...
objdir/i2cwrap.o: libraries/i2cwrap.c libraries/i2cmaster.h libraries/i2cwrap.h
	avr-gcc ./libraries/i2cwrap.c -o ./objdir/i2cwrap.o $(ILIBS) $(GCC_OPTS)
...
objdir/MPU9150.o: libraries/MPU9150.c libraries/MPU9150.h libraries/i2cwrap.h libraries/i2cmaster.h
	avr-gcc ./libraries/MPU9150.c -o ./objdir/MPU9150.o $(GCC_OPTS) $(ILIBS)

objdir/i2cmaster.o: libraries/twimaster.c
	avr-gcc ./libraries/twimaster.c -o ./objdir/i2cmaster.o $(ILIBS) $(GCC_OPTS)

objdir/uart.o: libraries/uart.c libraries/uart.h
	avr-gcc ./libraries/uart.c -o ./objdir/uart.o $(ILIBS) $(GCC_OPTS)

build/linkobj.out:
	avr-gcc ./objdir/*.o -o ./build/linkobj.out $(LD_OPTS)
